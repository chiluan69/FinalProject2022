...
<div class="wrapper">
  <header class="main-header" >
    ...
    <a href="" class="logo">
      ...
      <span class="logo-mini"><strong>GW</strong></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><strong>Greenwich VN </strong></span> 
    </a>
            	...
            	<li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li class="user-footer">
                        <div class="pull-left">
                          <a href="parents_profile.php" class="btn btn-default btn-flat">Profile</a>
                        </div>
